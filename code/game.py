...
class Game:
    ...
    def draw(self):
        ...
        self.draw_outlined_text_top_left(f'Score: {self.score}', self.font, (10, 10), WHITE, outline_width=2)
        self.draw_outlined_text_top_left(f'Level: {self.level}', self.font, (10, 40), WHITE, outline_width=2)
        self.draw_outlined_text_top_left(f'Invasão Zumbi: {self.passed_zombies}/{self.max_passed_zombies}', self.font,
                                         (10, 70), WHITE, outline_width=2)
        if self.is_rapid_fire_active():
            self.draw_outlined_text_top_left(f'Poder: Rajada ({self.get_rapid_fire_seconds_left()}s)', self.font,
                                             (10, 100), WHITE, outline_width=2)
        else:
            self.draw_outlined_text_top_left('Poder: Nenhum', self.font, (10, 100), WHITE, outline_width=2)
