...
#     selected_index = 0
#     font = pygame.font.SysFont("28 Days Later", 60, bold=False)
...
#                 if event.key == pygame.K_SPACE and not game.defeated and not game.victory:
#                     b = Bullet(game.player.rect.centerx, game.player.rect.top)
#                     game.bullets.add(b)
#                     game.all_sprites.add(b)
#                 elif event.key == pygame.K_RETURN and game.victory:
#                     state = "MENU"
#                     game = None
#
#         if state == "MENU":
...
#             draw_outlined_text(screen, "Tecla de Espaço: Atira", small_font, WHITE, (60, 250))
#             draw_outlined_text(screen, "Setas do teclado: Movimentação", small_font, WHITE, (60, 300))
...
def main():
    ...
    while running:
        ...
        if state == "MENU":
            ...
            draw_outlined_text(screen, "Controles", font, WHITE, (60, 100))
            draw_outlined_text(screen, "Tecla de Espaço: Atira", small_font, WHITE, (60, 250))
            draw_outlined_text(screen, "Setas do teclado: Movimentaçao", small_font, WHITE, (60, 300))
            draw_outlined_text(screen, "Tecla ESC: Pause", small_font, WHITE, (60, 350))
            draw_outlined_text(screen, "Pressione ENTER para voltar", small_font, (255, 255, 0), (60, 450))
